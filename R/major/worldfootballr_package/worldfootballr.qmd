...
To get the competition URLs needed for a lot of the functions in this document, refer to the column `comp_url` for the relevant league / competition you're interested in, 
in this stored data [file](https://github.com/JaseZiv/worldfootballR_data/blob/master/raw-data/all_leages_and_cups/all_competitions.csv).
